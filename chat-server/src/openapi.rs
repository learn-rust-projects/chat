...
use crate::{
    ...
    error::ErrorOutput,
    handlers::{AuthOutput, *},
    models::{CreateChat, CreateMessage, CreateUser, ListMessages, SigninUser, UpdateChat},
};
...
#[openapi(
        ...
        components(
            schemas(User, Chat, ChatType, ChatUser, Message, Workspace, SigninUser, CreateUser, UpdateChat, CreateChat, CreateMessage, ListMessages, AuthOutput, ErrorOutput),
        ),
