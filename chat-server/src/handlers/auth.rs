...
/// Sign in a user in the chat system with email and password.
///
/// - If the email or password is invalid, it will return 403.
/// - Otherwise, it will return 200 with a token.
...
mod tests {
    ...
    async fn signup_should_work() -> Result<()> {
        ...
        let input = CreateUser::new("Jack Chen", "Jack@acme.org", "Hunter42", "none");
